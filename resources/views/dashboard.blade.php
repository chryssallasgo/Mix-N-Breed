...
@section('content')
<div class="bg-white min-h-screen justify-center flex items-center">
    <div class="max-w-5xl mx-auto px-4 py-16">
        ...
        <div class="mb-12">
            ...
            <a href="#" class="inline-block bg-orange-400 text-white px-6 py-2 rounded-md font-semibold mb-4">Try it out!</a>
        </div>
