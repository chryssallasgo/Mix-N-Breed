...
<div class="max-w-7xl mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div class="bg-blue-50 shadow rounded p-6">
            <h2 class="text-xl font-semibold mb-2 text-blue-300">Total Registered Users</h2>
            <p class="text-4xl font-bold text-blue-300">{{ $totalUsers }}</p>
        </div>
        <div class="bg-yellow-50 shadow rounded p-6">
            <h2 class="text-xl font-semibold mb-2 text-orange-300">Total Dog Profiles</h2>
            <p class="text-4xl font-bold text-orange-300">{{ $totalDogProfiles }}</p>
        </div>
    </div>
